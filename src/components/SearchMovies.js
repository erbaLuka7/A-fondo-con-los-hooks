...
function SearchMovies(){
	...
	// Credenciales de API
	const apiKey = '645dd4a8'; // Intenta poner cualquier cosa antes para probar
	...
	const buscar = (e) => {
		e.preventDefault()
		setKeyword(buscado.current.value);
	}
						...
						<div className="col-12 col-md-6">
							...
							<form method="GET">
								<div className="form-group">
									...
									<input type="text" ref={buscado} className="form-control" />
								</div>
